...
ALLOWED_HOSTS = ['task-hero-y3xq.onrender.com']
...
# Base dir should already be defined like this:
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'static')]  # If you have a /static folder in your app
